                    ...
                    <div class="card">
                        <div class="card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Ejemplo: Juan Ramirez" class="form-control form-control-line" name="name" id="name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Direccion del proveedor</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Ejemplo: Lago Winnipeg" class="form-control form-control-line" name="address" id="address">
                                    </div>
                                </div>
                        </div>
                    </div>
